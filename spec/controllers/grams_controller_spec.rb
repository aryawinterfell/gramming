...
RSpec.describe GramsController, type: :controller do
    ...
    it "should have a 404 error if the gram cannont be found" do
  ...
  describe "grams#edit" do
    it "should successfully show the edit form if the gram id found" do
  ...
  describe "grams#show action" do
    it "should successfully show the page if the gram if found" do
